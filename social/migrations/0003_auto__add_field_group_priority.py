...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.priority'
        db.add_column('social_group', 'priority', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding M2M table for field members on 'Group'
        db.create_table('social_group_members', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('group', models.ForeignKey(orm['social.group'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('social_group_members', ['group_id', 'user_id'])

        # Adding M2M table for field groups on 'UserProfile'
        db.create_table('social_userprofile_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['social.userprofile'], null=False)),
            ('group', models.ForeignKey(orm['social.group'], null=False))
        ))
        db.create_unique('social_userprofile_groups', ['userprofile_id', 'group_id'])


    def backwards(self, orm):
        
        # Deleting field 'Group.priority'
        db.delete_column('social_group', 'priority')

        # Removing M2M table for field members on 'Group'
        db.delete_table('social_group_members')

        # Removing M2M table for field groups on 'UserProfile'
        db.delete_table('social_userprofile_groups')
    ...
    models = {
        ...
        'social.userprofile': {
            ...
            'groups': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['social.Group']", 'null': 'True', 'blank': 'True'}),
