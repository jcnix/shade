...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('social_userprofile_subscriptions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['social.userprofile'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('social_userprofile_subscriptions', ['userprofile_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field subscriptions on 'UserProfile'
        db.delete_table('social_userprofile_subscriptions')
    ...
    models = {
        ...
        'social.userprofile': {
            ...
            'subscriptions': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'subscriptions'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"}),
